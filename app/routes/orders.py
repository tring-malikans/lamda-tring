...
# PLace Market order
@router.get('/buy/{account}/{coin}/{pair}',response_description="PLace Buy Market Order")
...
# PLace Market order
@router.get('/sell/{account}/{coin}/{pair}',response_description="PLace Buy sell Order")
